        ...
        <footer className="flex justify-between py-4">
            <div className="">
                ...
                <ul>
                    ...
                    <li>
                        <a href={CV} target="_blank" rel="noreferrer">Voir mon CV</a>
                    </li>
                </ul>
            </div>
            <div className="flex items-end">
                <p>&copy; {(new Date()).getFullYear()} Maxence Castel. Tous droits réservés.</p>
            </div>
            <div>
                <h3 className="text-lg font-medium mb-2">Suivez-moi</h3>
